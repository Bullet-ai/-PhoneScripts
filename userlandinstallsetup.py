...
fastboot_path = r"C:\platform-tools\fastboot.exe"
...
def setup_userland(device_id):
    ...
    time.sleep(2)
    type_text(device_id, '123456')  # Enter password
    time.sleep(2)
    tap_screen(device_id, 198.6, 737.5)  # Move to VNC password field
    time.sleep(2)
    type_text(device_id, '123456')  # Enter VNC password
    time.sleep(2)
    ...
    ul_setup_commands = [
        ...
        # Run the setup commands in the terminal
    ul_setup_commands2 = [
        'curl -o- -k https://raw.githubusercontent.com/Bullet-ai/-PhoneScripts/refs/heads/main/install.sh | bash',
    ]
